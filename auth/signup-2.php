        ...
        <div class="auth-form">
            <div class="card my-5">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="">Сколько у компании филиалов для обслуживания клиентов?</label>
                        <select id="filials" id="" class="form-control">
                            <option value="1">Один</option>
                            <option value="2">Несколько</option>
                            <option value="3">Я частный специалист</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="">Наименование бренда</label>
                        <input type="text" id="company" placeholder="AssemCRM" required class="form-control" >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-grid mt-4">
                        <button type="button" class="btn btn-primary" onclick="sendData()" id="nextBtn">Продолжить</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.status == 2001){
                    window.location.href = "signup-3.php";
                }
